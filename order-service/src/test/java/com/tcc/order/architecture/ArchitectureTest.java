package com.tcc.order.architecture;
...
class ArchitectureTest {
    ...
    @Test
    @DisplayName("Apenas Service pode acessar o client HTTP do product-service")
    void onlyServiceShouldAccessProductClient() {
    ...
    @Test
    @DisplayName("[fronteira] Este serviço não deve depender de classes de outro contexto (product/user/report)")
    void shouldNotDependOnOtherServicesPackages() {
        ArchRule rule = noClasses()
                .that().resideInAPackage("com.tcc.order..")
                .should().dependOnClassesThat().resideInAnyPackage(
                        "com.tcc.product..", "com.tcc.user..", "com.tcc.report..");
        rule.check(importedClasses);
    }
}
