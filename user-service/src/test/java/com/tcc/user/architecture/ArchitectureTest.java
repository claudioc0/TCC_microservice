package com.tcc.user.architecture;
...
/**
 * Regras arquiteturais aplicadas DENTRO deste microsserviço.
 *
 * A fronteira com os OUTROS serviços (user/product/order/report) é garantida
 * fisicamente: eles não compartilham classpath — este teste só enxerga
 * as classes de com.tcc.user, nunca as de outro serviço.
 */
class ArchitectureTest {
    ...
    static void setup() {
        importedClasses = new ClassFileImporter()
                ...
                .importPackages("com.tcc.user");
    }

    @Test
    @DisplayName("Controllers não devem acessar Repositories diretamente (devem passar por Services)")
